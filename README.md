...
New projects should follow the Android Gradle project structure that is defined on the [Android Gradle plugin user guide](http://tools.android.com/tech-docs/new-build-system/user-guide#TOC-Project-Structure). The [FAD Sample](https://github.com/firmaautografa/android-sample) project is a good reference to start from.
...
```java
loadPicture(context, "http://i.imgur.com/DvpvklR.png", imageViewProfilePicture, clickListener, "Title of the picture");
```
